...
namespace XRift.VrmExporter.Utils
{
    ...
    internal static class UnityExtensions
    {
        ...
        public static material.TextureFilterMode ToTextureFilterMode(this FilterMode self)
        {
            return self switch
            {
                FilterMode.Point => material.TextureFilterMode.Nearest,
                FilterMode.Bilinear => material.TextureFilterMode.Linear,
                FilterMode.Trilinear => material.TextureFilterMode.LinearMipmapLinear,
                _ => throw new ArgumentOutOfRangeException(),
            };
        }

        public static material.TextureWrapMode ToTextureWrapMode(this TextureWrapMode self)
        {
            return self switch
            {
                TextureWrapMode.Clamp => material.TextureWrapMode.ClampToEdge,
                TextureWrapMode.Mirror => material.TextureWrapMode.MirroredRepeat,
                TextureWrapMode.Repeat => material.TextureWrapMode.Repeat,
                _ => throw new ArgumentOutOfRangeException(),
            };
        }
