...
namespace XRift.VrmExporter.VRM.Gltf
{
    using System.Numerics;
...
namespace XRift.VrmExporter.VRM.SpringBone
{
    using IExtensions = IDictionary<string, JToken>;
...
namespace XRift.VrmExporter.VRM.Constraint
{
    using IExtensions = IDictionary<string, JToken>;
...
namespace XRift.VrmExporter.VRM.MToon
{
    using IExtensions = IDictionary<string, JToken>;
...
namespace XRift.VrmExporter.VRM
{
    public static class Document
    {
        ...
        public static JToken SaveAsNode(SpringBone.SpringBone springBone)
        {
            return JToken.FromObject(springBone, JsonSerializer.Create(SerializerOptions));
        }

        public static JToken SaveAsNode(SpringBone.ExtendedCollider collider)
        {
